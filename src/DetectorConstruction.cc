...
#include "DetectorMessenger.hh" // <--- 【新增】引入 Messenger 头文件
...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
    ...
    auto physsheild = new G4PVPlacement(nullptr, G4ThreeVector(0, 0,0), logicalSheild, "Shield", logicWorld, false, 0, checkOverlaps);
    ...
    G4double detCenterZ = shieldZ/2 + distantZ + detZ/2; 
    auto physDet = new G4PVPlacement(nullptr, G4ThreeVector(0, 0, detCenterZ), logicalDet, "Detector", logicWorld, false, 0, checkOverlaps);
